...
module.exports = {
  view: function (vnode) {
    return m("dl", [
      m("dt", ["Radio overall size", m("span", `100〜${vnode.attrs.vm.getRadioCircleSize()}`)]),
      m("dd", [
        m('input[type="number"]', {
      ...
      m("dt", ["Radio circle size", m("span", `${vnode.attrs.vm.getRadioSize()}〜10`)]),
      m("dd", [
        m('input[type="number"]', {
      ...
      m("dt", ["CheckBox size", m("span", `100〜${vnode.attrs.vm.getCheckboxIconSize()}`)]),
      m("dd", [
        m('input[type="number"]', {
      ...
      m("dt", ["Checked icon size", m("span", `${vnode.attrs.vm.getCheckboxSize()}〜10`)]),
      m("dd", [
        m('input[type="number"]', {
      ...
      m("dt", ["Checked icon border size", m("span", `${Math.floor(vnode.attrs.vm.getCheckboxIconSize() / 5)}〜1`)]),
      m("dd", [
        m('input[type="number"]', {
