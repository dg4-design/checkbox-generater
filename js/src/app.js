...
const RadioCheckboxCSSGenerater = {
  ...
  view: function (vnode) {
    return m("div", [
      ...
      m("div.Grid", [
        ...
        m("div.Grid--child", [m("h2", "Control Panel"), m(StatusChangeComponent, { vm: vnode.state.vm })]),
      ]),
      m("div.Grid", [
        m("div.Grid--child", [
          m("h2", "DOM"),
          m(
            "textarea",
            { style: { "min-height": "200px" }, readonly: "readonly" },
            `<ul>
  ...
  <li><label class="checkbox_text"><input type="checkbox">CheckBox Text</label></li>
        ...
        m("div.Grid--child", [m("h2", "CSS"), m("textarea", { style: { "min-height": "400px" }, readonly: "readonly" }, vnode.state.vm.getStyle())]),
      ]),
    ]);
  },
};
